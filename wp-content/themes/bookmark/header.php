...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?= get_template_directory_uri() ?>/assets/img/favicon-32x32.webp">
    ...
    <header class="header">
        <div class="header__container">
            ...
            <div class="header__menu">
                ...
                wp_nav_menu([
                    ...
                    'menu'            => '',
                    'container'       => 'nav',
                    'container_class' => 'header__menu--nav',
                    'container_id'    => '',
                    'menu_class'      => '',
                    'menu_id'         => '',
                    'echo'            => true,
                ...
                ?>
                <a href="#" class="btn btn__red">Login</a>
            </div>
            <a href="" class="mobile__menu--btn">
        ...
        <div class="mobile__menu">
            ...
            <div class="mobile__menu--nav">
                ...
                ?>
                <a href="#" class="btn btn__opc">Login</a>
            </div>
